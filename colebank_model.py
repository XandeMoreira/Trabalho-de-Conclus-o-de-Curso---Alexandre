...
def Modelo(y,t,pars,kEa,kRs,kRp,kT): #,KEa,KRs,KRp,KT):
...
if __name__ == "__main__":
    ...
    #solution = odeint(Modelo, y0, t, args=(pars,))
    # get solution
    Vsa = solution[:,0]
    Vsv = solution[:,1]
    Vpa = solution[:,2]
    ...
    CalcOutputs(k,t,T,psa,ppa,ppv,Vlv,plv,Vrv,prv,pra)
    ...
    PlotPressures(t[k:],plv[k:],prv[k:],psa[k:],psv[k:],ppa[k:],ppv[k:],path)
